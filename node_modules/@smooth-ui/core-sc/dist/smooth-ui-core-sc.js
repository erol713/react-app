(function (global, factory) {
...
}(this, function (exports, PropTypes$1, styled, polished, React, reactDom, PopperJs) { 'use strict';
  ...
  function getSystemPropTypes(system) {
    ...
    return system.meta.props.reduce(function (obj, prop) {
      obj[prop] = PropTypes$1.oneOfType([PropTypes$1.number, PropTypes$1.string, PropTypes$1.object]);
      return obj;
    }, {});
  }
  ...
  createComponent(function () {
    return {
      ...
      propTypes: {
        children: PropTypes$1.node,
        up: PropTypes$1.oneOf(['xs', 'sm', 'md', 'lg', 'xl']),
        down: PropTypes$1.oneOf(['xs', 'sm', 'md', 'lg', 'xl'])
      }
    };
  });
    ...
    var Col = createComponent(function () {
      return {
        ...
        propTypes: {
          ...
          xs: PropTypes$1.oneOfType([PropTypes$1.bool, PropTypes$1.string, PropTypes$1.number]),
          sm: PropTypes$1.oneOfType([PropTypes$1.bool, PropTypes$1.string, PropTypes$1.number]),
          md: PropTypes$1.oneOfType([PropTypes$1.bool, PropTypes$1.string, PropTypes$1.number]),
          lg: PropTypes$1.oneOfType([PropTypes$1.bool, PropTypes$1.string, PropTypes$1.number]),
          xl: PropTypes$1.oneOfType([PropTypes$1.bool, PropTypes$1.string, PropTypes$1.number]),
          oxs: PropTypes$1.oneOfType([PropTypes$1.string, PropTypes$1.number]),
          osm: PropTypes$1.oneOfType([PropTypes$1.string, PropTypes$1.number]),
          omd: PropTypes$1.oneOfType([PropTypes$1.string, PropTypes$1.number]),
          olg: PropTypes$1.oneOfType([PropTypes$1.string, PropTypes$1.number]),
          oxl: PropTypes$1.oneOfType([PropTypes$1.string, PropTypes$1.number])
        }
      };
    });
  ...
  createComponent(function () {
    return {
      ...
      propTypes: {
        children: PropTypes$1.node,
        valid: PropTypes$1.bool.isRequired
      }
    };
  });
  ...
  FocusLock.propTypes = process.env.NODE_ENV !== "production" ? {
    ...
    shards:
    /*#__PURE__*/
    PropTypes$1.arrayOf(PropTypes$1.any),
    as:
    /*#__PURE__*/
    PropTypes$1.oneOfType([PropTypes$1.string, PropTypes$1.func, PropTypes$1.object]),
  ...
  ***************************************************************************** */
  ...
  var elementCouldBeScrolled = function elementCouldBeScrolled(node) {
    return window.getComputedStyle(node).overflowX !== 'hidden';
  };
  ...
  Transition.propTypes = process.env.NODE_ENV !== "production" ? {
    ...
    children:
    /*#__PURE__*/
    PropTypes$2.oneOfType([PropTypes$2.func.isRequired, PropTypes$2.element.isRequired]).isRequired,
  ...
  createComponent(function () {
    return {
      ...
      propTypes: {
        ...
        initialFocusRef: PropTypes$1.object
      },
      defaultProps: {
        persistent: true
      }
  ...
  createComponent(function () {
    return {
      ...
      propTypes: {
        checked: PropTypes$1.bool,
        disabled: PropTypes$1.bool,
        labeled: PropTypes$1.bool,
        onLabel: PropTypes$1.string,
        offLabel: PropTypes$1.string,
        onChange: PropTypes$1.func
      }
    };
  });
  ...
  function create$4() {
    ...
    Toggler.propTypes = {
      ...
      defaultToggled: PropTypes$1.bool,
  ...
  createComponent(function () {
    return {
      ...
      propTypes: {
        children: PropTypes$1.node,
        variant: PropTypes$1.oneOf(['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'display-1', 'display-2', 'display-3', 'display-4'])
      }
    };
  });
